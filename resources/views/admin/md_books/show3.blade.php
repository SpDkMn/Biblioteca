<div class="box box-warning">
	...
	<div class="box-body">
		...
		<div class="box-body col-md-7">
			<h3>
				<b><font face="Calibri">Resumen</font></b>
			</h3>
			<div class="container">{{$book->summary}}</div>
			<h3>
				<b><font face="Calibri">Contenido</font></b>
			</h3>
			@foreach($book->chapters as $chapter)
			<p>&nbsp&nbsp&nbsp&nbsp-&nbsp&nbsp{{$chapter->number}}.&nbsp&nbsp&nbsp&nbsp{{$chapter->name}}</p>
			@endforeach
			<h3>
				<b><font face="Calibri">Descripcion Fisica</font></b>
			</h3>
			<p>&nbsp&nbsp&nbsp&nbsp-Extension                 <?php for($i=0;$i<66;$i++){echo "&nbsp";}?>:&nbsp {{$book->extension}}</p>
			<!-- 17 -->
			<p>&nbsp&nbsp&nbsp&nbsp-Otros detalles fisicos    <?php  for($i=0;$i<45;$i++){echo "&nbsp";}?>:&nbsp {{$book->physicalDetails}}</p>
			<!-- 4 -->
			<p>&nbsp&nbsp&nbsp&nbsp-Dimensiones               <?php for($i=0;$i<60;$i++){echo "&nbsp";}?>:&nbsp {{$book->dimensions}}</p>
			<!-- 15 -->
				...
				<div class="box-body table-responsive">
					<table class="table table-condensed">
						<tr>
							...
							<th colspan="2"><font size="2"></font><a type="button"
								class="button-content btn btn-default btn-xs">Añadir mas +</a></th>
						...
						<tr>
							...
							<td><a type="button"
								class="button-content btn btn-success btn-xs"><i
									class="fa fa-pencil"></i></a></td>
							<td><a type="button" class="button-content btn btn-danger btn-xs"><i
        ...
        <a href="#0" type="button"
				class="button-content btn btn-warning libros"><i class="fa fa-book"></i></a>
			<a href="#1" data-id="{{$book->id}}" class="btn btn-primary pagina1">1</a>
			<a href="#2" data-id="{{$book->id}}"
				class="btn btn-primary active pagina2">2</a>
		</div>
		<br>
	</div>
