<div class="box box-primary">
	...
	<div class="box-body">
		...
		<form class="form-horizontal" role="form" method="POST"
			action="{{ url('/admin/usuarios') }}" enctype="multipart/form-data"
			files="true" name="formulario_ingreso_usuario"
			id="formulario_ingreso_usuario">
			...
			<div class="form-group" id="cuadro_facultad">
				...
				<div class="col-md-9">
					<select name="faculty" id="faculty" class="form-control" required>
						<option value="Ingenieria de Sistemas e Informatica" selected>Facultad
						...
						<option value="Ingenieria de Minas">Facultad de Ingenieria de
							Minas</option>
					</select>
				</div>
			</div>
			...
			<div class="form-group " id="cuadro_universidad">
				...
				<div class="col-md-9">
					<select name="university" id="university" class="form-control"
						required>
						<option value="Universidad Nacional Mayor de San Marcos" selected>Universidad
							Nacional Mayor de San Marcos</option>
						<option value="Universidad Nacional de Ingeniería">Universidad
