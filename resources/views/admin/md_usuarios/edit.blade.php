<div class="box box-primary"  >
  ...
  <div class="box-body" >
                ...
                @if($user!=null)
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/usuarios') }}/{{$user->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <select name="tipo_academico" id="tipo_academico" class="form-control" >
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="last_name" placeholder="Apellidos" name="last_name" value="{{ $user->last_name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="code" placeholder="Codigo" name="code" value="{{ $user->code }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_dni">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="dni" placeholder="DNI" name="dni" value="{{ $user->dni }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_telefono">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="home_phone" placeholder="Telefono" name="home_phone" value="{{ $user->home_phone }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_celular">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="phone" placeholder="Telefono" name="phone" value="{{ $user->phone }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_correo">
                            ...
                            <div class="col-md-9">
                              <input type="email" class="form-control" id="email" placeholder="Correo" name="email" value="{{ $user->email }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_direccion">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="address" placeholder="Direccion" name="address" value="{{ $user->address }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_escuela">
                            ...
                            <div class="col-md-9">
                              <select name="school" id="school" class="form-control">
                                <option value="Sistemas" <?php  if($user->school=="Sistemas"){echo("selected");} ?> >Sistemas</option>
                                <option value="Software" <?php  if($user->school=="Software"){echo("selected");} ?> >Software</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="cuadro_facultad">
                            ...
                            <div class="col-md-9">
                              <select name="faculty" id="faculty" class="form-control">
                                <option value="Ingenieria de Sistemas e Informatica" <?php  if($user->faculty=="Ingenieria de Sistemas e Informatica"){echo("selected");} ?> >Facultad de Ingeniería de Sistemas e Informática</option>
                                <option value="Ciencias Sociales" <?php  if($user->faculty=="Ciencias Sociales"){echo("selected");} ?> >Facultad de Ciencias Sociales</option>
                                <option value="Derecho" <?php  if($user->faculty=="Derecho"){echo("selected");} ?> >Facultad de Derecho</option>
                                <option value="Ingenieria de Minas" <?php  if($user->faculty=="Ingenieria de Minas"){echo("selected");} ?> >Facultad de Ingenieria de Minas</option>
                              </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group " id="cuadro_universidad">
                            ...
                            <div class="col-md-9">
                              <select name="university" id="university" class="form-control">
                                <option value="Universidad Nacional Mayor de San Marcos" <?php  if($user->university=="Universidad Nacional Mayor de San Marcos"){echo("selected");} ?> >Universidad Nacional Mayor de San Marcos</option>
                                <option value="Universidad Nacional de Ingeniería" <?php  if($user->university=="Universidad Nacional de Ingeniería"){echo("selected");} ?> >Universidad Nacional de Ingeniería</option>
                              </select>
                            </div>
                        </div>
