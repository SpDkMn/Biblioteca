			...
			<table id="example1" class="table table-bordered table-hover" >
						...
						<?php //dd($universities[0]->name);?>
							...
							<tr >
								...
								<td id="celda"><center><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalCopy<?php echo $user->id; ?>"><i class="fa fa-eye"></i></button></center></td>

								<div  class="modal  fade" id="ModalCopy<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalCopyLabel">
...
<!--  ACA COMIENZA EL MODAL ________________________________________________________ -->
    ...
    <div class="box box-warning box-solid" style=" border-color:blue;">
      ...
      <div class="box-body">
      <h2 style="margin-top: 0px; margin-left: 36px; font-size: 35px;"><strong>{{ Auth::user()->code }}</strong></h2>
      <div style="background-image: url(/img/avatar5.png); height: 120px;
    width: 120px; background-repeat: no-repeat;
    background-position: 50%;
    border-radius: 50%; background-size: 100% auto; border: 2px solid black; margin-left:50px; margin-bottom: 17px; margin-top: 10px;"></div>
    ...
    <div class="box box-warning box-solid" style=" border-color:blue;">
      ...
      <div class="box-body">
        <strong style="float:left"><i class="fa fa-book margin-r-5"></i>  Libros Pedidos</strong>
        <div style="margin-left: 170px;">0</div>
        
        <strong style="float:left"><i class="fa fa-book margin-r-5"></i>  Tesis Pedidas</strong>
        <div style="margin-left: 170px;">0</div>
        
        
        <strong style="float:left"><i class="fa fa-book margin-r-5"></i>  Castigos</strong>
        <div style="margin-left: 170px;">0</div>
    
        <strong style="float:left"><i class="fa fa-book margin-r-5"></i>  Pedido</strong>
        <div style="margin-left: 170px;">No</div>
  
        <strong style="float:left"><i class="fa fa-book margin-r-5"></i>  Estado</strong>
        <?php 
        	if($user->state==true){
  ...
  <div class="col-md-9" >
    <div class="box box-warning box-solid" style=" border-color:blue; height: 493px;">
      <div class="box-header with-border" style="background-color:blue;">
...
<!--  ACA TERMINA EL MODAL ________________________________________________________ -->
												...
												<div class="modal-footer" style="padding:40px; padding-top:0px; height:50px;">
													<button type="button" class="btn btn-primary" data-dismiss="modal" style="width:100px;" padd">Salir</button>
												</div>
											</form>
										</div>
									</div>
								...
								<td id="celda" style="text-align: center;"><a type="button" data-id="{{$user->id}}" class="btn btn-success editar" href="{{route('usuarios.edit',$user->id)}}"><i class="fa fa-pencil"></i></a></td>  
								...
								<form action="{{ route('usuarios.destroy',$user->id )}}" method="POST">
					              ...
					              {{ csrf_field() }}
					              <button type="submit" data-id="{{$user->id}}" class="btn btn-danger eliminar"><i class="fa fa-trash"></i></button>
