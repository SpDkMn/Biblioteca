...
alert("entro");
 ...
 <!--onchange="handleFileSelect() -->
  ...
  @endif
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/noticias') }}" enctype="multipart/form-data" files="true" name="formulario_ingreso_noticia" id="formulario_ingreso_noticia">
