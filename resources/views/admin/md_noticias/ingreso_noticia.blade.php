...
<div class="box-body" id="cuadro_ingresar_noticia">
	...
	<div class="col-md-3" id="boton_crear_noticia"
		...
		<a href="http://127.0.0.1:8000/admin/noticias/show"
			class="btn btn-primary">Vista de Noticia</a>
	</div>
	<h1 id="titulo_ingresar_noticia">Ingresar Noticia</h1>

	<form class="form-horizontal" role="form" method="POST"
		action="{{ url('/admin/noticias') }}" enctype="multipart/form-data"
		files="true" name="formulario_ingreso_noticia"
		id="formulario_ingreso_noticia">
		...
		<div class="form-group">
			<label for="palabra_clave" class="control-label col-md-2">Palabra
				clave:</label>
			<div class="col-md-9">
