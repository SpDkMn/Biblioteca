...
<!-- Font Awesome -->
    ...
    <div class="box-body" id="cuadro_muestra_noticia" style="">
      <div class="col-md-4" id="boton_crear_noticia" style="padding-left: 2px;">
                      <a href="http://127.0.0.1:8000/admin/noticias/show" class="btn btn-primary">Vista de Noticia</a>
                      <a href="http://127.0.0.1:8000/admin/noticias/create" class="btn btn-primary" style="margin-left: 5px">Crear una nueva Noticia</a>
                   </div>
       <h1 id="titulo_muestra_noticia">Visualización de Noticia</h1>
       <div id="semicuadro_muestra_noticia" style="width: 900px; background-color: white; margin: auto auto; padding-top: 0px; border-style:solid; border-width:5px; padding-bottom: 17px;">
         <h2 id="titulo_noticia"></h2>
         
         <img src="" class='img-responsive hidden' alt='Responsive image' style='width: 450px; height: 250px; margin: auto auto;' id="imagen_noticia_arriba" >
         
       
         <div id="cuadro_contenido_imagen_noticia" class="clearfix" style=" width: 860px; margin: auto auto;">
           <img src="" class='img-responsive hidden' alt='Responsive image' style='width: 190px; height: 190px;float:left; margin-left: 11px; margin-right: 13px; border-style:solid; border-width:4px; margin-bottom: 20px;' id="imagen_noticia_arriba_izquierda">
           <p id="contenido_noticia"></p>
         </div>
         <img src="" class='img-responsive hidden' alt='Responsive image' style='width: 450px; height: 250px; margin: auto auto;' id="imagen_noticia_abajo" >
      </div>
    </div>
<div class="box-body" id="cuadro_actualizar_noticia">
  ...
  @endif
                  ...
                  <div class="col-md-9">
                  {!!Form::text('titulo',null,['class'=>'form-control','placeholder'=>'Ingrese el Titulo de la Noticia', 'id'=>'titulo'])!!}
                  </div>
                  </div>
                  <div class="form-group">
               		   {!!Form::label('palabra_clave','Palabra clave:',['class'=>'control-label col-md-2'])!!}
           			 <div class="col-md-9">
           			 		{!!Form::select('palabra_clave', ['sin_especificar' => 'Sin especificar', 'autores' => 'Autores', 'editoriales'=>'Editoriales','revistas'=>'Revistas'],null,['class' => 'form-control'])!!}
          			  </div>
         		 </div>

         		 <div class="form-group">
         		 		{!!Form::label('contenido','Contenido:',['class'=>'control-label col-md-2'])!!}
                      <br/><br/>
                      <div class="box-body pad col-md-10 col-md-offset-1">

                      		{!!Form::textarea('contenido',null,['class'=>'form-control','placeholder'=>'This is my textarea to be replaced with CKEditor.','id'=>'editor1','rows'=>'10','cols'=>'80'])!!}
                          
                    </div>
                  </div>

                  <div class="form-group">
                  {!!Form::label('urlImg','URL Imagen:',['class'=>'control-label col-md-2'])!!}
                  <div class="col-md-9">
                  {!!Form::text('urlImg',null,['class'=>'form-control','placeholder'=>'URL de la Imagen', 'id'=>'urlImg'])!!}
                  </div>
                  
                  </div>
                  <div class="form-group hidden" id="div_imagen" >
                  <div class="col-md-2" style="margin-top: 20px;">
                    <div style=" margin-left: 133px; font-weight: bold;">
                    Imagen:
                    </div>
                  </div>
                  <div class="cold-md-9">
                    <img src="" class='img-responsive' alt='Responsive image' style='max-width: 250px; margin-left: 230px;' id="muestra_imagen" >
                  </div>
                  </div>
			...
			//	echo "variablePHP = ".$valor_3;
				?>
       			 ...
       			 <div class="form-group">
       			 	{!!Form::label('localizacion','Localización:',['class'=>'control-label col-md-2'])!!}
        		    <div class="col-md-9">
        		    	{!!Form::select('localizacion', ['arriba_izquierda' => 'Arriba-Izquierda', 'arriba_derecha' => 'Arriba-Derecha', 'arriba'=>'Arriba','abajo'=>'Abajo'],null,['class' => 'form-control','disabled'=>'true', 'id'=>'localizacion', 'onload'=>'funcion_1()'])!!}
           			 </div>
       			 </div>
             <script type="text/javascript">
               ...
               else
               {
                ...
                document.getElementById('muestra_imagen').setAttribute("src","/imgNoticias/"+valor_imagen.value);
                   ...
                   <div class="col-md-1 col-md-offset-5">
                      <button class="btn btn-primary" style="margin-left: 20px;"><i class="fa fa-envelope-o"></i>Editar</button>
                   </div>
                </div>
              ...
              <script src="http://localhost/Proyectos/Biblioteca/public/css/jquery-2.2.3.min.js"></script>
	<script src="http://localhost/Proyectos/Biblioteca/public/css/bootstrap.min.js"></script>
	<!-- jQuery 2.1.4 -->
