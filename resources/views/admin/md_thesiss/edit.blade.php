  ...
  @if($id!=null)
    @foreach($thesiss as $thesis)
      ...
      <form method="POST" action="{{ url('/admin/thesis')}}/{{$id}}">
              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        @foreach($autores as $autor)
                          @foreach($autor->categories as $category)
                            @if($category->name == "Tesis"){
                              <!-- Si el id del autor del bucle es igual al autor del autor seleccionada  -->
                              @if($autor->id == $thesis->author->id)
                    ...
                    <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control" name="issn" id="inputISSN" placeholder="" value="{{$thesis->issn}}"> -->
                    </div>
        ...
        <!-- Declarando el contador de items -->
        <?php $contContent = 0  ?>
              @foreach($thesis->contents as $contenido)
