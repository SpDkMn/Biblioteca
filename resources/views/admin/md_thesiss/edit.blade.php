<div class="box box-primary">
	...
	@if($id!=null) @foreach($thesiss as $thesis) @if($thesis->id == $id)
	<form method="POST" action="{{ url('/admin/thesis')}}/{{$id}}">
		...
		<div class="box-body">
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<p>
											...
											<input type="radio" class="flat" name="tipo" value="tesis"
												checked="" required /> Tesis <br> <input type="radio"
												class="flat" name="tipo" value="tesina" /> Tesina
										</p>
									</div>

									<div class="form-group">
										<label for="inputTitle">Titulo</label> <input type="text"
											class="form-control" value="{{$thesis->title}}" name="title"
											id="inputTitle" placeholder="">
									</div>

									<div class="form-group">
										<label>Autor Principal</label> <select
											class="form-control select" id="selectAutorMainEdit"
											name="autorMain[]" multiple="multiple" style="width: 100%;"
											data-placeholder="Autor Principal"> @foreach($autores as
            ...
            ?>>{{$autor->name}}</option> @endif
									...
									<div class="form-group">
										<label>Autor Secundario</label> <select
											class="form-control select" id="selectAutorSecondEdit"
											name="autorSecond[]" multiple="multiple" style="width: 100%;"
											data-placeholder="                                          Si no tiene deje en blanco">
											@foreach($autores as $autor) @foreach($autor->categories as
											$category) @if($category->name == "tesis/tesina")
											<option value="{{ $autor->id }}"
												<?php
            foreach ($thesis->authors as $aut) {
            ...
            ?>>{{$autor->name}}</option>
									...
									<div class="form-group">
										<label>Editorial</label> <select class="form-control select"
											name="editorial" style="width: 100%;"> @foreach($editoriales
											as $editorial) @foreach($editorial->categories as $category)
											@if($category->name == "tesis/tesina")
									...
									<div class="form-group">
										<label for="Clasification">Clasificación</label> <input
											type="text" class="form-control"
											value="{{$thesis->clasification}}" name="clasification"
											id="inputClasification" placeholder="">
									</div>


									<div class="form-group">
										<label>Asesor</label> <select class="form-control select"
											name="asesor" style="width: 100%;"> @foreach($autores as
											$autor) @foreach($autor->categories as $category)
									...
									<div class="form-group">
										<label for="escuela">E . A . P : </label> <input type="text"
											class="form-control" name="escuela"
											value="{{$thesis->escuela}}" id="inputEscuela" placeholder="">
									</div>
							...
							<div class="tab-pane fade" id="sexto">
								<div class="box-body">
									<div class="form-group">
										<label for="inputEdition">Edicion</label> <input type="text"
											class="form-control solo-numeros"
											value="{{$thesis->edition}}" name="edition" id="inputEdition"
											placeholder="">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Extension</label> <input
											type="text" class="form-control solo-numeros"
											value="{{$thesis->extension}}" name="extension"
											id="inputEXTENSION" placeholder="">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Dimensiones</label> <input
											type="text" class="form-control"
											value="{{$thesis->dimensions}}" name="dimension"
											id="inputEXTENSION" placeholder="">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Detalles Físicos</label> <input
											type="text" class="form-control"
											value="{{$thesis->physicalDetails}}" name="detalles"
											id="inputEXTENSION" placeholder="">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Material Adicional</label> <input
											type="text" class="form-control"
											value="{{$thesis->accompaniment}}" name="materialad"
											id="inputEXTENSION" placeholder="">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Ubicacion</label> <input
											type="text" class="form-control"
											value="{{$thesis->location}}" name="ubicacion"
											id="inputEXTENSION" value="Stand ">
									</div>

									<div class="form-group">
										<label for="inputEXTENSION">Lugar de sustentacion</label> <input
											type="text" class="form-control"
											value="{{$thesis->publicationLocation}}" name="lugarsus"
											id="inputEXTENSION"
											value="Facultad de Ingeniería de Sistemas">
									</div>
								</div>
							</div>
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="summary"
											id="inputSummary" placeholder="">{{$thesis->summary}}</textarea>
									</div>

									<div class="form-group">
										<label for="inputContent">Contenido</label>
										<textarea class="form-control" name="contenido"
											id="inputContent" placeholder="">{{$thesis->conten}}</textarea>
									</div>

									<div class="form-group">
										<label for="inputRecomend">Conclusiones y Recomendaciones</label>
										<textarea class="form-control" name="recomendacion"
											id="inputRecomend" cols="65">{{$thesis->recomendacion}}</textarea>
									</div>

									<div class="form-group">
										<label for="inputBibliografia">Bibliografia</label>
										<textarea class="form-control" name="bibliografia"
											id="inputBibliografia" cols="65">{{$thesis->bibliografia}}</textarea>
									</div>
              ...
              @if($loop->first)
                  <div class="box box-default box-solid"
										...
										<div class="box-header">
											...
											<div class="box-tools pull-right">
												<button type="button" name="copy0" id="agregarItemEdit"
										...
										<div class="box-body">
											...
											<div class="form-group">
												<label for="inputIncomeNumber">Nº Ingreso</label> <input
													type="text" class="form-control solo-numeros"
													value="{{$item->incomeNumber}}"
													name="{{'incomeNumber'.$contItem}}" id="inputIncomeNumber"
													placeholder="">
											</div>
											<div class="form-group">
												<label for="inputBarcode">Código de barra</label> <input
													type="text" class="form-control solo-numeros"
													value="{{$item->barcode}}" name="{{'barcode'.$contItem}}"
													id="inputBarcode" placeholder="">
											</div>
											<div class="form-group">
												<label for="inputCopy">Ejemplar</label> <input type="text"
													style="background: white; width: 54px;" value="1"
													class="form-control solo-numeros" name="copy0"
													id="inputCopy" placeholder="" required>
											</div>
									...
									@else
									<div class="BoxItemThesiss box box-default box-solid"
										id="{{'itemPanel'.$contItem}}">
										<div class="box-header">
										...
										<div class="box-body">
											...
											<div class="form-group">
												<label for="inputCopy">Ejemplar</label> <input type="text"
													style="background: white; width: 54px;"
													value="{{$contItem + 1}}" class="form-control solo-numeros"
													name="{{'copy'.$contItem}}" id="inputCopy" placeholder=""
													required>
											</div>
										</div>
