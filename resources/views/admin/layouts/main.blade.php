...
<link href="{{URL::asset('css/ChartSty.css')}}" rel="stylesheet">      <!-- Contiene los estilos de uno de los graficos estadisticos -->
...
<!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="{{URL::asset('js/grafico1.js')}}"></script>
