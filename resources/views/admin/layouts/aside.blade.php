  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview @if(URL::full() == url('/admin/noticias') || URL::full() == url('/admin/noticias')) active @endif  ">
        ...
        <ul class="treeview-menu">
          <li @if(URL::full() == url('/admin/noticias/create'))class="active"@endif><a href="{{ url('/admin/noticias/create') }}"><i class="fa"></i> <span>Crear Notica</span></a></li>
          <li @if(URL::full() == url('/admin/noticias/show'))class="active"@endif><a href="{{ url('/admin/noticias/show') }}"><i class="fa"></i> <span>Ver Noticia</span></a></li>
        </ul>
      </li>
