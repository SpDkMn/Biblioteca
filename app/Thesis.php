...
{   
	...
	protected $fillable = ['type','clasification','title','edition','nhojas','extension','dimensions','physicalDetails','accompaniment','conten','summary','recomendacion','bibliografia','location','publicationLocation','asesor'];
