...
class CompendiumController extends Controller{
  //Terminado
    ...
    $edit = view('admin.md_compendium.edit',['compendios'=>$compendios,
                                              'copias_compendios'=>$copias_compendios,
                                              'contenidos'=>$contenidos,
                                              'editoriales'=>$editoriales,
                                              'autores'=>$autores,
     ...
     return view('admin.md_compendium.index',['new' => $new,
                                            'show'=>$show,
                                            'edit'=>$edit,
                                            'delete'=>$delete,
                                            'content'=>$content,
  ...
  public function edit($id){
    ...
    return view('admin.md_compendium.edit',['id'=>$id,
                                          'compendios'=>$compendios,
  ...
  public function update(Request $request, $id){
    ...
    //********************************************************************************************************
    /* PRUEBAS */
    // dd($request->all(),$request['clasification1'],$compendio->Compendiums_copies,'Copias luego de editar:',$contador_copia ,'Copias antes de Editar:',$contador_copia2);
    //********************************************************************************************************
    ...
    //Actualizando datos de compendio
      ...
      if(is_string($request['editorial'])){$request['editorial'] = (int)$request['editorial'];}
  ...
  public function itemDetail($id){
    $compendios = Compendium::all();
    return view('admin.md_compendium.items',['compendios'=>$compendios,
                                          'id'=>$id]);
  }
}
