...
Route::get('/sanciones/{idUser}/visualizacion', function ($id) {
    $Usuario=App\User::with(['penalties'])->find($id);
         return view('admin.md_sanciones.visualizacion',[
             'Usuario' => $Usuario
          ]);
    });
Route::get('/sanciones/{idUser}/crearSancion', function ($id) {
    $Usuario=App\User::with(['penalties'])->find($id);
    $tiposanciones=App\TypePenalty::all();
         return view('admin.md_sanciones.new',[
             'Usuario' => $Usuario,
